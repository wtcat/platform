...
$(BUILD)/bin/goahead.out: $(DEPS_42)
	...
	$(CC) -o $(BUILD)/bin/goahead.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/goahead.o" $(LIBPATHS_42) $(LIBS_42) $(LIBS_42) $(LIBS) -Wl,-r 
...
$(BUILD)/bin/goahead-test.out: $(DEPS_43)
	...
	$(CC) -o $(BUILD)/bin/goahead-test.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/test.o" $(LIBPATHS_43) $(LIBS_43) $(LIBS_43) $(LIBS) -Wl,-r 
...
$(BUILD)/bin/gopass.out: $(DEPS_44)
	...
	$(CC) -o $(BUILD)/bin/gopass.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/gopass.o" $(LIBPATHS_44) $(LIBS_44) $(LIBS_44) $(LIBS) -Wl,-r 
