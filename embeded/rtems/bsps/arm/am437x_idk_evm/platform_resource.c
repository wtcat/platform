...
TEMPLATE_RESOURCE(uart2, "ti,am4372-uart", "ttyS2", DRVMGR_BUS_TYPE_PLATFORM,
  	TRN("REG0", DRVMGR_KT_INT, 0x48024000),
  	TRN("IRQ0", DRVMGR_KT_INT, nIRQ(74))
);
TEMPLATE_RESOURCE(uart3, "ti,am4372-uart", "ttyS3", DRVMGR_BUS_TYPE_PLATFORM,
  	TRN("REG0", DRVMGR_KT_INT, 0x481a6000),
  	TRN("IRQ0", DRVMGR_KT_INT, nIRQ(44))
);
TEMPLATE_RESOURCE(uart4, "ti,am4372-uart", "ttyS4", DRVMGR_BUS_TYPE_PLATFORM,
