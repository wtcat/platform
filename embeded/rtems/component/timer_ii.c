...
static inline void timer_ii_unlock(Per_CPU_Control *cpu,
  ISR_lock_Context *lock_context) {
	_Watchdog_Per_CPU_release_critical(cpu, lock_context);
	_ISR_lock_ISR_enable(lock_context);
}

static inline int timer_ii_add_locked(Per_CPU_Control *cpu, 
...
static inline int timer_ii_remove_locked(Per_CPU_Control *cpu, 
