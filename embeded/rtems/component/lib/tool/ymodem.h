...
#ifndef LIB_TOOL_YMODEM_H_
#define LIB_TOOL_YMODEM_H_
 ...
 * second.
 */
int rym_recv_on_device(struct rym_ctx *ctx, rt_device_t dev, rt_uint16_t oflag,
 ...
 * second.
 */
int rym_send_on_device(struct rym_ctx *ctx, rt_device_t dev, rt_uint16_t oflag,
                            rym_callback on_begin, rym_callback on_data, rym_callback on_end,
                            int handshake_timeout);
